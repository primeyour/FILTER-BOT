...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002405400154').split()]
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'cllection')
