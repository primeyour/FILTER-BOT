...
PICS = (environ.get('PICS', "https://envs.sh/Jkb.jpg")).split() #SAMPLE PIC
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 't.meKeralaLeechHelp') # Support Chat Link Without https:// or @
...
MSG_ALRT = environ.get('MSG_ALRT', 'hello brother')
