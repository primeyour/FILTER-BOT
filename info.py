...
PM_SEARCH = is_enabled(environ.get('PM_SEARCH', 'False'), True)  # Fixed PM_SEARCH to True by default
...
if any(cred in DATABASE_URI for cred in ['password', 'secret', 'token']):
    logger.warning("Potential sensitive information detected in DATABASE_URI")
